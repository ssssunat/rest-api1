...
type ServerInterface interface {
	...
	// (DELETE /messages/{id})
	DeleteMessagesId(ctx echo.Context, id int64) error
	// Update message by id
	// (PATCH /messages/{id})
	PatchMessagesId(ctx echo.Context, id int64) error
}
...
func (sh *strictHandler) DeleteMessagesId(ctx echo.Context, id int64) error {
...
func (sh *strictHandler) PatchMessagesId(ctx echo.Context, id int64) error {
